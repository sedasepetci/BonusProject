...
namespace Bonusproject.DataSet1TableAdapters {
    ...
    public partial class Tbl_DerslerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Tbl_Dersler] ([Dersad]) VALUES (@Dersad);\r\nSELECT Dersid, Dersad FRO" +
                "M Tbl_Dersler AS Tbl_Dersler_1 WHERE (Dersid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Tbl_Dersler] SET [Dersad] = @Dersad WHERE (([Dersid] = @Original_Dersid) " +
                ...
                ");\r\nSELECT Dersid, Dersad FROM Tbl_Dersler AS Tbl_Dersler_1 WHERE (Dersid = @Der" +
                "sid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Tbl_Dersler_1.*\r\nFROM     Tbl_Dersler AS Tbl_Dersler_1";
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT Tbl_Ogrencilerr.Ogrenciid, Tbl_Ogrencilerr.ogrenciad, Tbl_Ogrencilerr.ogrencisoyad, Tbl_Ogrencilerr.ogrencicinsiyet, Tbl_Kulupler.kulupad
FROM     Tbl_Ogrencilerr INNER JOIN
                  Tbl_Kulupler ON Tbl_Ogrencilerr.ogrencikulup = Tbl_Kulupler.kulupid";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT Tbl_Ogrencilerr.Ogrenciid, Tbl_Ogrencilerr.ogrenciad, Tbl_Ogrencilerr.ogrencisoyad, Tbl_Ogrencilerr.ogrencicinsiyet, Tbl_Kulupler.kulupad
FROM     Tbl_Ogrencilerr INNER JOIN
                  Tbl_Kulupler ON Tbl_Ogrencilerr.ogrencikulup = Tbl_Kulupler.kulupid
WHERE  (Tbl_Ogrencilerr.ogrenciad = @ograd)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO Tbl_Ogrencilerr\r\n                  (ogrenciad, ogrencisoyad, ogrencik" +
                "ulup, ogrencicinsiyet)\r\nVALUES (@ograd,@ogrsoyad,@ogrekulup,@ogrcinsiyet)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ogrekulup", global::System.Data.SqlDbType.TinyInt, 1, global::System.Data.ParameterDirection.Input, 0, 0, "ogrencikulup", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE Tbl_Ogrencilerr\r\nSET          ogrenciad = @ograd, ogrencisoyad = @ogrsoyad" +
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ogriid", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Ogrenciid", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "DELETE FROM Tbl_Ogrencilerr\r\nWHERE  (Ogrenciid = @ogrid)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, false)]
        public virtual int OgrenciEkle(string ograd, string ogrsoyad, global::System.Nullable<byte> ogrekulup, string ogrcinsiyet) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((ograd == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            if ((ogrekulup.HasValue == true)) {
                command.Parameters[2].Value = ((byte)(ogrekulup.Value));
            }
            else {
...
SELECT Notid, Dersid, Ogrenciid, Sinav1, Sinav2, Sinav3, Proje, Ortalama, Durum FROM Tbl_Notlar WHERE (Notid = @Notid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "DELETE FROM Tbl_Notlar\r\nWHERE  (Ogrenciid = @Ogrid)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, false)]
        public virtual int NotSil(global::System.Nullable<int> Ogrid) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((Ogrid.HasValue == true)) {
